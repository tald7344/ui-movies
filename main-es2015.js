...
SidebarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: SidebarComponent, selectors: [["app-sidebar"]], inputs: { menus: "menus" }, decls: 32, vars: 0, consts: [[1, "login-sidebar"], [1, "col-11", "col-sm-10", "mx-auto"], [1, "top-login", "mt-5", "pb-5"], [1, "row"], [1, "col"], [1, "light-orange"], [1, "col", "text-right"], ["aria-hidden", "true", 1, "fa", "fa-times", "fa-fw", "fa-2x", "text-white", 3, "click"], [1, "login-image", "mt-5", "mx-auto"], [1, "login-form", "text-center", "mx-auto", "mt-4"], [1, "form-group", "position-relative"], ["type", "text", "name", "name", "placeholder", "Username", 1, "p-2"], [1, "fa", "fa-user", "fa-fw", "light-orange", "custom-user-icon"], ["type", "password", "name", "password", "placeholder", "Password", 1, "p-2"], ["aria-hidden", "true", 1, "fa", "fa-lock", "fa-fw", "light-orange"], ["aria-hidden", "true", 1, "fa", "fa-eye", "fa-fw", "light-orange", "custom-eye-icon"], [1, "custom-checkbox", "custom-control", "light-orange"], ["type", "checkbox", "id", "customCheck1", 1, "custom-control-input"], ["for", "customCheck1", 1, "custom-control-label"], ["type", "submit", "name", "submit", 1, "btn", "btn-block", "mt-5", "btn-custom"], [1, "text-center", "text-white", "my-4"], [1, "text-center", "light-orange", "my-4"]], template: function SidebarComponent_Template(rf, ctx) { if (rf & 1) {
